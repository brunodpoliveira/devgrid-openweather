...
def group_id_array_loop():
    g_id_array = ["3439525", "3439781", "3440645", "3442098", "3442778", "3443341", "3442233", "3440781", "3441572",
    ...
    for i in range(len(g_id_array)):
        # base_url + group_id + api_key +  = final url (units changed to metric - standard is kelvin)
        url = main.read_api().creds['BASE_URL'] + "group?id=" + g_id_array[i] + "&appid=" + main.read_api().owm_obj
